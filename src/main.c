...
g_signal_connect(G_OBJECT(button_one), "clicked", G_CALLBACK(button_one_clicked), "1");
button_two = gtk_button_new_with_label("2");
g_signal_connect(G_OBJECT(button_two), "clicked", G_CALLBACK(button_two_clicked), "2");
button_three = gtk_button_new_with_label("3");
g_signal_connect(G_OBJECT(button_three), "clicked", G_CALLBACK(button_three_clicked), "3");
button_four = gtk_button_new_with_label("4");
g_signal_connect(G_OBJECT(button_four), "clicked", G_CALLBACK(button_four_clicked), "4");
button_five = gtk_button_new_with_label("5");
g_signal_connect(G_OBJECT(button_five), "clicked", G_CALLBACK(button_five_clicked), "5");
button_six = gtk_button_new_with_label("6");
g_signal_connect(G_OBJECT(button_six), "clicked", G_CALLBACK(button_six_clicked), "6");
button_seven = gtk_button_new_with_label("7");
g_signal_connect(G_OBJECT(button_seven), "clicked", G_CALLBACK(button_seven_clicked), "7");
button_eight = gtk_button_new_with_label("8");
g_signal_connect(G_OBJECT(button_eight), "clicked", G_CALLBACK(button_eight_clicked), "8");
button_nine = gtk_button_new_with_label("9");
g_signal_connect(G_OBJECT(button_nine), "clicked", G_CALLBACK(button_nine_clicked), "9");
button_zero = gtk_button_new_with_label("0");
g_signal_connect(G_OBJECT(button_zero), "clicked", G_CALLBACK(button_zero_clicked), "0");

button_divide = gtk_button_new_with_label("/"); 
g_signal_connect(G_OBJECT(button_divide), "clicked", G_CALLBACK(button_divide_clicked), "/");
button_multiply = gtk_button_new_with_label("*");
g_signal_connect(G_OBJECT(button_multiply), "clicked", G_CALLBACK(button_multiply_clicked), "*");
button_plus = gtk_button_new_with_label("+");
g_signal_connect(G_OBJECT(button_plus), "clicked", G_CALLBACK(button_plus_clicked), "+");
button_minus = gtk_button_new_with_label("-");
g_signal_connect(G_OBJECT(button_minus), "clicked", G_CALLBACK(button_minus_clicked), "-");
button_allclear = gtk_button_new_with_label("AC");
g_signal_connect(G_OBJECT(button_allclear), "clicked", G_CALLBACK(button_allclear_clicked), "AC");
button_leftBracket = gtk_button_new_with_label("(");
g_signal_connect(G_OBJECT(button_leftBracket), "clicked", G_CALLBACK(button_leftBracket_clicked), "(");
button_rightBracket = gtk_button_new_with_label(")");
g_signal_connect(G_OBJECT(button_rightBracket), "clicked", G_CALLBACK(button_rightBracket), ")");
button_point = gtk_button_new_with_label(".");
g_signal_connect(G_OBJECT(button_point), "clicked", G_CALLBACK(button_point_clicked), ".");
button_result = gtk_button_new_with_label("Вычислить");
g_signal_connect(G_OBJECT(button_result), "clicked", G_CALLBACK(button_result_clicked), "=");
